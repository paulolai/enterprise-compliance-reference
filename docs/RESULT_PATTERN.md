...
See `implementations/executable-specs/shared/src/result.ts` for the full implementation and `implementations/executable-specs/unit/test/result.spec.ts` for comprehensive examples.
