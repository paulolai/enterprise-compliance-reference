...
#### The Decision
All test data generation lives in a monorepo-style `implementations/executable-specs/shared` directory, consumed by both API and GUI test suites.
...
#### Structure
```
implementations/executable-specs/shared/
├── fixtures/
...
#### Rule
*   **Never Duplicate Builders:** If you need a helper for test data, it belongs in `implementations/executable-specs/shared/fixtures`.
...
#### References
*   Implementation: `implementations/executable-specs/shared/src/result.ts`
*   Tests: `implementations/executable-specs/unit/test/result.spec.ts` (42 tests)
