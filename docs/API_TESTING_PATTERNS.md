...
```typescript
// implementations/executable-specs/unit/test/pricing.properties.test.ts
...
```typescript
// implementations/executable-specs/shared/fixtures/arbitraries.ts
...
```typescript
// implementations/executable-specs/unit/test/integration.properties.test.ts
